...
@section('content-body')
    <div class="container border">
        <div class="row">
            <div class="col">
                <form action="{{route('nhtadmin.nhtkhachhang.nhtCreateSubmit')}}" method="POST">
                    @csrf
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nhtMaKhachHang" name="nhtMaKhachHang" value="{{ old('nhtMaKhachHang') }}" >
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" id="nhtNgayDangKy" name="nhtNgayDangKy" value="{{ old('nhtNgayDangKy') }}" >
                                @error('nhtNgayDangKy')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <label for="nhtTrangThai1"> Hoạt Động</label>
                                    &nbsp;
                                    <input type="radio" id="nhtTrangThai1" name="nhtTrangThai" value="1"/>
                                    <label for="nhtTrangThai0">Tạm Khóa</label>
                                    &nbsp;
